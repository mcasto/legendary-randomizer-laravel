...
export default function Welcome({
    ...
    const setNumPlayers = async (numPlayers:number) => {
        // setLoading(true);
        try {
          // Send the number of players to the backend and get the random game setup
          const response = await wretch(`/api/randomizer/${numPlayers}`)
            .get()
            .json();

            console.log({response})

        //   setGameSetup(response); // Assuming the backend returns the game setup
        } catch (error) {
